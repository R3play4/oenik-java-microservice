...
public class CustomLogger {
    ...
    @Pointcut(value = "@within(hu.yokudlela.foodAndDrinks.utils.logging.AspectLogger) && execution(public * *(..))")
    @Order(1)
    public boolean executionOfAnyPublicMethodInAtLoggedType() {return true;}

    @Pointcut(value = "execution(* *(..)) && @annotation(hu.yokudlela.foodAndDrinks.utils.logging.AspectLogger)")
    @Order(2)
